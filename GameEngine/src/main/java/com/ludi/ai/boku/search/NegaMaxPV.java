...
public class NegaMaxPV implements ISearch {
     ...
     * Constructor
     */
    public NegaMaxPV(IMoveManager movemanager, IHeuristicsManager heuristicsManager, ITranspositionTable ttable) {
    ...
    private Move doIterativeDeepening(
        ...
        while (initialdepth <= finaldepth) {
            bestmove = negamaxSearchMovePV(moveManager, context, initialdepth,currentPly);
            initialdepth++;
        }
